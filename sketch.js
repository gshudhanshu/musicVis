...
var musicPlaylist = [
...

  {
    ...
    thumb:
      'assets/music/thumb/Defqwop - Say The Word (feat. The Ruins) [NCS Release].jpg',
...

  {
    ...
    thumb:
      'assets/music/thumb/Different Heaven - Nekozilla (LFZ Remix) [NCS Release].jpg',
...

  {
    ...
    thumb:
      'assets/music/thumb/Jim Yosef & Anna Yvette - Courage [NCS Release].jpg',
    title: 'Courage [NCS Release]',
    composer: 'Jim Yosef & Anna Yvette',
    length: '3:44',
  },
...
function preload() {
  ...
  bgImg = loadImage(
    'https://images.unsplash.com/photo-1482686115713-0fbcaced6e28?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=747'
  )
